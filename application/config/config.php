...
|
*/
$config['base_url'] = 'http://localhost/INTERN/PCC';
...
|
*/
$config['encryption_key'] = 'RgUkXp2r5u8x/A?D';
...
$config['sess_timeout'] = 1800; // 30 minutes
$config['sess_check_interval'] = 60; // 1 minute
// 
